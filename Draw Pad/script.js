...
var isHidden = false; // Variable zur Verfolgung des Ausblendstatus

// Die ursprünglichen Klassen der Divs speichern
var originalClasses = {};

var divs = document.querySelectorAll(".content-div");

divs.forEach(function (div) {
    originalClasses[div] = div.className;
});

// Eventlistener, um Divs ein- oder auszublenden und den Originalzustand wiederherzustellen
document.getElementById("toggleButton").addEventListener("click", function () {
    divs.forEach(function (div) {
        if (isHidden) {
            div.style.display = "block"; // Oder verwenden Sie "inline" oder "flex", abhängig von Ihrem Layout
            div.className = originalClasses[div]; // Originalklasse wiederherstellen
        } else {
            div.style.display = "none";
            div.className = "content-div hidden"; // Klasse für ausgeblendete Divs hinzufügen
        }
    });

    isHidden = !isHidden; // Umgekehrten Status festlegen
});